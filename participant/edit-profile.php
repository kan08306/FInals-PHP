<?php
$page_title = 'Shenanovents | Edit Profile';
$current_page = 'events';
$base_path = '../';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($form_action === 'update_profile') {
        ...
        $email = $_POST['email'] ?? '';
        $result = participant_update_profile($conn, $participant_id, $first_name, $last_name, $email, $_FILES['profile_picture'] ?? null);

        if ($result['success']) {
            participant_flash('success', 'Profile updated successfully.');
    ...
    if ($form_action === 'change_password') {
        ...
        $result = participant_change_password($conn, $participant_id, $current_password, $new_password, $confirm_password);
    ...
    <div class="profile-shell">
        <div class="profile-header-card">
            ...
            <div class="profile-identity">
                <span class="event-badge">Participant Account</span>
